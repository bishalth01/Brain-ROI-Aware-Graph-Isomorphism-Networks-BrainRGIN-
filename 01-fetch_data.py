...
root_folder = '/data/users2/bthapaliya/BrainGNNABCD/data/'
data_folder = os.path.join(root_folder, 'ABIDE_pcp/cpac/filt_noglobal/Output')
...
def main():
    parser = argparse.ArgumentParser(description='Download abcde  ABIDE data and compute functional connectivity matrices')
