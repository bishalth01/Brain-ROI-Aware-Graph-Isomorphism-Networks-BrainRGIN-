...
wandb.init(project='results_abcd_gin_topk_mean', save_code=True, config="/data/users2/bthapaliya/IntelligenceABCDPredictionBrainGNN/wandb_sweeps/default_test_sweep.yaml")
...
model = CustomNetworkGINWithMean(opt.indim,opt.ratio,opt.nclass,opt.n_layers,opt.n_fc_layers,opt.n_clustered_communities,opt.nroi,opt.reg).to(device)
