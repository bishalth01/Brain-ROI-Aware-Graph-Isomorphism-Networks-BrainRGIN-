...
from net.sero.dynamicbraingnnmean import CustomNetworkGINSeroMean
import numpy as np
import argparse
import time
import copy
...
model = CustomNetworkGINSeroMean(opt.indim,opt.ratio,opt.nclass,opt.n_layers,opt.n_fc_layers,opt.n_clustered_communities,opt.nroi,opt.reg).to(device)
